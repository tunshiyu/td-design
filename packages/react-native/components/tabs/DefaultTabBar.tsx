              ...
              >
                ...
                >
                  {tabs.map((name, index) => {
                    ...
                    return this.renderTab(tab, index, tabWidth, this.measureTab.bind(this, index), styles, theme);
                  })}
                  {renderUnderline ? renderUnderline(underlineProps.style) : <Animated.View {...underlineProps} />}
                </View>
              </ScrollView>
            </View>
          );
